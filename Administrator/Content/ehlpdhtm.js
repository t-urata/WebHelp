...
//{{HH_SYMBOL_SECTION
var HH_ChmFilename = "C:\\VSS\\プロダクト\\TimeTracker FX\\Current\\ドキュメント\\日本語版\\作業用\\ヘルプ\\Administrator\\Administrator.chm";
var HH_WindowName = "AdministratorHelp";
var HH_GlossaryFont = "";
var HH_Glossary = "0";
var HH_Avenue = "0";
...
function BSSCPopup_ResizeAfterLoad(nIndex, nToken, cuswidth, cusheight)
{
	...
	if (gbBsIE55 )
	{
	    getPopupTopicStyle(nIndex).width = nWidth + 22+ "px" ;
		getPopupTopicStyle(nIndex).height = nHeight + 30+ "px" ;
		getPopupIFrameStyle(nIndex).width = nWidth + 22+ "px" ;
	    getPopupIFrameStyle(nIndex).height = nHeight + 30+ "px" ;
	}	
...
function BSSCGetContentSize(thisWindow, size)
{
	...
	if (miny > GoldenSize.y) // the popup does not fix in the parent wanted golden area. so try to expand itself as large as it can
	{
		...
		if (miny > maxy) { // the popup must have a scroll, OK let it be.
			...
			size.x = getScrollWidth(thisWindow) + getBscrollWidth();; //+ gBscrollWidth;
			size.y = getScrollHeight(thisWindow) + getBscrollHeight();// + gBscrollHeight;	
		...
		if (getScrollWidth(thisWindow) > maxgoldx) {
			...
			size.x = getScrollWidth(thisWindow)+ getBscrollWidth();
			size.y = getScrollHeight(thisWindow)+ getBscrollHeight() ;
